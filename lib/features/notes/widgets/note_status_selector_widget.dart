...
class NoteStatusSelector extends StatelessWidget {
  final NoteStatus currentStatus;
  final Function(NoteStatus) onStatusChanged;

  const NoteStatusSelector({
    super.key,
            ...
            return Container(
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected
                        ? NoteStatusColors.getBackgroundColor(
                            status,
                    ...
                    border: Border.all(
                      color: isSelected
                          ? NoteStatusColors.getChipColor(status)
                  ...
                  child: Row(
                    children: [
                      Container(
                        padding: const EdgeInsets.all(8),
                        decoration: BoxDecoration(
                          color: NoteStatusColors.getChipColor(status),
                          borderRadius: BorderRadius.circular(8),
                        ),
                        child: Text(
                          status.emoji,
  ...
  String _getStatusDescription(NoteStatus status) {
    switch (status) {
